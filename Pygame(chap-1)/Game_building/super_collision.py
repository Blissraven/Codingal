...
background_image = pygame.transform.scale(pygame.image.load(r"C:\Users\User\Desktop\Codingal\Pygame(chap-1)\Game_building\☆_𓋼𓍊 𓆏 𓍊𓋼𓍊.jpg"),(SCREEN_WIDTH , SCREEN_HEIGHT))
...
sprite2.rect.x, sprite2.rect.y = random.randint(
    0, SCREEN_HEIGHT - sprite2.rect.width), random.     randint(0,SCREEN_HEIGHT - sprite2.rect.height)
